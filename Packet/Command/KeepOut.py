...
class KeepOut(CommandInterface):
    ...
    def EncodePacket(self) -> bytes:
        ...
        Header = struct.pack(self.FORMAT_STRING, KeepOut.COMMAND_ID, self.PacketID)
    ...
    def DecodePacket(EncodedString: str, DecodeResult: DecodeFormat) -> CommandInterface | str:
        ...
        FormatString = KeepOut.FORMAT_STRING + "dd" * int(CoordinateCount)
